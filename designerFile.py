...
# Form implementation generated from reading ui file '.\quickPatch.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.panCounterClockwiseButton, 1, 2, 1, 1)
        self.panClockwiseButton = QtWidgets.QPushButton(self.centralwidget)
        self.panClockwiseButton.setObjectName("panClockwiseButton")
        self.gridLayout_3.addWidget(self.panClockwiseButton, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addItem(spacerItem4, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.connectToArduinoButton, 1, 1, 1, 1)
        self.confirmIMEIButton = QtWidgets.QPushButton(self.centralwidget)
        self.confirmIMEIButton.setObjectName("confirmIMEIButton")
        self.gridLayout.addWidget(self.confirmIMEIButton, 0, 1, 1, 1)
